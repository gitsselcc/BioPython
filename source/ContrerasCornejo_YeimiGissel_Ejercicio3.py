...
class proteina (trna):
    ...
    def alto_peso(self):
        return len(self.peso_mol)<100

g1=gen ("Mario ", " panza ", "ATGCGTACGTAGCTAGCTAG","gen")
t1 = trna("Jlslsls", "rodilla ", "AUGGCCAUUGUAAUGGGCCGCUUAA", "trna","ACCG")
n1 = rna_nocod("protozoo ", "cabeza ", "AUCGGAUUGCGCUAGC", "noncodrna","loop")
p1 = proteina("2.2320", "tlatenango", "GGCCAUUGUAAUGGGCCGCUUAA","proteina","CCC","200")
...
print("Anticodon:", p1.anticodon, "| Peso molecular:", p1.peso_mol, "| Alto peso:", p1.alto_peso(), "| Longitud:", p1.longitud())
